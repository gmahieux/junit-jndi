...
public class SimpleInitialContextTest
{
	...
	public void testBindThreeLevelsOnRootContext() throws Exception
	{
		...
		assertThat(subContext1.getCurrentEntry()).isEqualTo(TypeJndiEntry.ROOT);
		...
		assertThat(subContext2.getCurrentEntry()).isEqualTo(TypeJndiEntry.ROOT);
		...
		assertThat(subContext3.getCurrentEntry()).isEqualTo(TypeJndiEntry.ROOT);
	...
	public void testBindThreeLevelsOnGlobalContext() throws Exception
	{
		...
		assertThat(subContext1).isNotNull();
		assertThat(subContext1.getCurrentEntry()).isEqualTo(TypeJndiEntry.GLOBAL);
		assertThat(subContext1.getCurrentSubContext()).isEqualTo("aaa");

		final SimpleInitialContext subContext2 = (SimpleInitialContext)subContext1.createSubcontext("bbb");
		assertThat(subContext2).isNotNull();
		assertThat(subContext2.getCurrentEntry()).isEqualTo(TypeJndiEntry.GLOBAL);
		assertThat(subContext2.getCurrentSubContext()).isEqualTo("aaa/bbb");

		final SimpleInitialContext subContext3 = (SimpleInitialContext)subContext2.createSubcontext("java:global/ccc");
		assertThat(subContext3).isNotNull();
		assertThat(subContext3.getCurrentEntry()).isEqualTo(TypeJndiEntry.GLOBAL);
		assertThat(subContext3.getCurrentSubContext()).isEqualTo("aaa/bbb/ccc");
	...
	public void testBindComplex() throws Exception
	{
		...
		assertThat(subContext1).isNotNull();
		assertThat(subContext1.getCurrentEntry()).isEqualTo(TypeJndiEntry.APPLICATION);
		...
		assertThat(subContext2).isNotNull();
		assertThat(subContext2.getCurrentEntry()).isEqualTo(TypeJndiEntry.APPLICATION);
		...
		assertThat(subContext3).isNotNull();
		assertThat(subContext3.getCurrentEntry()).isEqualTo(TypeJndiEntry.APPLICATION);
		...
		assertThat(subContext4.getCurrentEntry()).isEqualTo(TypeJndiEntry.APPLICATION);
