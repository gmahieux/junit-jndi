...
{
	private static final String[] JNDI_NAMES_ALLOWED = new String[TypeJndiEntry.values().length];
	...
	@Nonnull
	private final TypeJndiEntry jndiType;
	...
	public JndiEntryResolver(@Nullable final String originalName, @Nullable TypeJndiEntry parentJndiEntry, @Nullable String originalParentName) throws NamingException
	{
	...
	@SuppressWarnings("null")
	@Nonnull
	public TypeJndiEntry getJndiType()
	{
		return jndiType;
	}
	...
	@VisibleForTesting
	@Nonnull
	protected TypeJndiEntry detectJndiEntryType(@Nullable final String jndiName)
	{
		for (TypeJndiEntry tje : TypeJndiEntry.values())
		{
		...
		return TypeJndiEntry.ROOT;
	}

	@Nonnull
	@VisibleForTesting
	protected String detectResolvedName(@Nullable final String originalName, @Nonnull final TypeJndiEntry jndiType, @Nullable String originalParentName)
	{
	...
	private String detectResolvedParentName(@Nonnull final TypeJndiEntry jndiType, @Nullable String originalParentName)
	{
